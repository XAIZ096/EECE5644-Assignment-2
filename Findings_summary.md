...
Fiber optic internet is by far the priciest add-on, adding about $24.95 to the monthly
...
Knowing exactly which services a customer has tells us a lot more than just knowing how
many they've signed up for. Our model explains 99.9% of the variation in monthly charges
...
$14 on average. That gap makes sense once you think about it: two customers can both
...
from about $18 to $119 a month, being off by less than a dollar is a genuinely tight fit.

## 8. Do the coefficients match Telco's price list, and anything surprising?

The coefficients come out remarkably close to round numbers like $5, $10, $20, and $25,
...
negative $25.05. That's not a discount for skipping internet. It's just a side effect of
...
negative adjustment. It's worth explaining this clearly in the writeup so it doesn't get
misread as the model finding a "negative-priced" service.
